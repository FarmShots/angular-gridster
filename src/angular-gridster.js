...
(function(root, factory) {
	...
	.constant('gridsterConfig', {
		...
		outerMargin: true,
		stretchHeight: true, // whether or not to grow height automatically when approaching bottom border
	...
	.controller('GridsterCtrl', ['gridsterConfig', '$timeout', '$rootScope',
		function(gridsterConfig, $timeout, $rootScope) {
			...
			this.autoSetItemPosition = function(item) {
				...
				$rootScope.$broadcast('gridster-grid-full', item);
			};
			...
			this.updateHeight = function(plus) {
				if (!this.stretchHeight && this.movingItem) {
					return;
				}
